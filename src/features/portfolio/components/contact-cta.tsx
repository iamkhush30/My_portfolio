...
export const ContactCTA = () => {
  return (
    <a
      ...
      className="group relative z-20 flex flex-col items-center justify-center transition-all duration-700 px-6 w-full gap-6 bg-secondary border-t border-border !py-10 section-light snap-start snap-always overflow-hidden"
    >
      ...
      <h2 className="text-heading text-foreground group-hover:text-primary transition-colors duration-500 text-center flex items-center justify-center gap-4 md:gap-8 max-w-[1400px]">
        ...
        <div className="relative flex items-center justify-center w-10 h-10 md:w-12 md:h-12 shrink-0">
          <div className="relative overflow-hidden w-6 h-6 md:w-8 md:h-8 flex items-center justify-center">
