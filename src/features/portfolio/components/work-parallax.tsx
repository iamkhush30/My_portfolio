...
const ProjectSection = ({ project, index }: { project: Project, index: number }) => {
  ...
  return (
    <div 
      ref={cardRef}
      className="relative w-full py-[var(--space)] border-b border-border/50 bg-white"
    >
...
export const WorkParallax = () => {
  return (
    <section id="work" className="relative z-20 bg-[#FFFFFF] py-[var(--space)] overflow-hidden border-t">
      ...
      <div className="container mx-auto px-6 py-[var(--space)] flex flex-col items-center justify-center text-center">
