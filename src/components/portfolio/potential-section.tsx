...
export const PotentialSection = () => {
  ...
  return (
    <div id="potential-section" className="relative z-10 flex flex-col items-center justify-center overflow-visible pt-16 pb-0">
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none"
        style={{ backgroundImage: 'radial-gradient(#0F172A) 1px, transparent 0)', backgroundSize: '32px 32px' }}>
      </div>

      <div className="container mx-auto px-6 md:px-12 relative z-10 flex flex-col items-center">
        <div className="w-full text-center mb-16 pointer-events-none">
          <h2 className="text-display select-none text-[#0F172A] tracking-wide">
            Working To Full Potential
          </h2>
        </div>

        <div className="relative w-full max-w-5xl aspect-[1.5/1] md:aspect-[2/1] flex items-end justify-center overflow-hidden">
            ...
            <div className="flex items-center justify-center w-full">
              <RippleButton className="pill-btn group h-14 px-10 rounded-[45px] border-2 border-[#333] bg-[#111] cursor-pointer overflow-hidden outline-none flex items-center justify-center gap-4 transition-all duration-200 min-w-[200px]">
                <div className="relative z-20 flex items-center gap-4 pill-text transition-colors duration-700 group-hover:text-[#111]">
                  <span className="text-button lowercase tracking-widest text-[#F8FAFC]">Resume</span>
                  <div className="w-6 h-6 bg-[#F8FAFC] rounded-full flex items-center justify-center transition-colors duration-700">
          ...
          <div
            ...
            style={{
              ...
              maskImage: 'radial-gradient(circle at 50% 100%, black 0%, black 28%, transparent 29%)',
              WebkitMaskImage: 'radial-gradient(circle at 50% 100%, black 0%, black 28%, transparent 29%)',
            }}
          />

          <div
            className="absolute bottom-0 left-1/2 -translate-x-1/2 origin-bottom w-[2px] h-[85%] transition-transform duration-200 ease-out z-20 flex flex-col items-center"
