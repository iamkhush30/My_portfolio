...
export const ContactCTA = () => {
  return (
    <a 
      ...
      className="group relative z-20 flex flex-col items-center justify-center transition-all duration-700 px-6 w-full gap-6 bg-secondary border-t border-border !py-16 section-light snap-start snap-always overflow-hidden"
    >
