...
import { Palette, Layout, Server, Cpu, MousePointer2, Activity } from 'lucide-react';
...
export const HybridVisual = () => {
  return (
    <div className="relative w-full aspect-square max-w-[550px] mx-auto flex items-center justify-center group">
      ...
      {/* Node 2: Web Designing (Bottom Left - SECONDARY) */}
      <div className="absolute bottom-[10%] left-[5%] z-20 flex flex-col items-center transition-all duration-700">
        <div className="p-3 bg-white border border-primary/10 rounded-xl shadow-lg flex flex-col gap-2 min-w-[160px] animate-float backdrop-blur-md">
           <div className="flex items-center gap-2">
             <Layout className="w-4 h-4 text-primary" />
             <span className="text-[9px] font-black text-[#1A1A1A] uppercase tracking-wider">Web Designing</span>
           </div>
           <div className="w-full h-px bg-primary/5"></div>
        </div>
        <div className="w-px h-8 bg-gradient-to-t from-primary/30 to-transparent mt-1 rotate-[45deg] origin-top"></div>
      </div>
